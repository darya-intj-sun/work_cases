...
## case_3
В данной папке приведены примеры моделирования бизнес-логики в формате нотации BPMN (главный процесс), а также отдельной проработки подпроцессов в виде диаграммы последовательности и подробного ТЗ с алгоритмом расчета и макетами интерфейса.:
