...
- Бизнес-требования, общие требования к задаче;
- Включение РСЭ - описание сценария включения и выключения расширенной фунцкицональной системы с привязкой к экранным формам, логикой сохранения и переноса результатов прошлый экспертизы;
- Роли и права на экспертизы - описание прав и ограничений по каждой роли;
- Логика экспертизы пользователей с разными ролями - здесь представлен весь бизнес-процесс, учитывающий взаимодействие пользователей разных ролей и отдельно описанеи свернутых подпроцессов экспертизы по каждой роли (нотация BPMN).
